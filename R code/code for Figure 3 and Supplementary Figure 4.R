rm(list=ls())
library(forestplot)
data <- read.csv ('data for Figure 3.csv') ###Reading in data for Figure 3
#data <- read.csv ('data for Supplementary Figure 4.csv')  ###Reading in data for Supplementary Figure 4
tabletext<-cbind( 
